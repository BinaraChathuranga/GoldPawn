...
class TransControllerCO extends Controller
{
    /**
    ...
    {
      return view('co_admin.inTransCO');
    }
    ...
    public function edit($id)
    {
        ...
        return view('co_admin.editTransCO')->with('eTrans',$transaction);
    }
