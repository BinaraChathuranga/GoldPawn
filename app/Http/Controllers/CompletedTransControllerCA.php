...
use App\ledger;
use App\income;
class CompletedTransControllerCA extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      return view('co_admin.CompletedTransactionsCO')->with('completed',$completed);
    }
    ...
    public function store(Request $request, CompletedTransactions $Ctransactions, ledger $ledger, income $income)
    {
        ...
        return view('co_admin.completedInvoiceCO')->with('completedTrans', $CompleteInvoice);
    }
    /**
