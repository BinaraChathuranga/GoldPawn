...
class RenewTransControllerCO extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      return view('co_admin.renewedTransactionCO')->with('renewed',$renewed); 
    }
    ...
    public function store(Request $request, renewTransactions $Rtransactions,ledger $ledger,income $income )
    {
        ...
        return view('co_admin.renewInvoiceCO')->with('RenewTrans', $RenewInvoice);
    }
