   ...
   <div class="row">
       <div class="col-12 ">
        ...
        <table class="table  table-striped" >
           <tr>
               <td style="text-align: left;"> <b>Transaction : {{$mInvoice->id}}  </b> </td>
               <td style="text-align: right;"> Date :  &nbsp; Time : <?php $time=date("h:i:s"); echo $time ?> </td>
               <td>  </td>
           </tr>
       </table>
       ...
       <div class="col-3 offset-1">
            ...
            <table class="table-sm">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>{{$mInvoice->marketPrice}} LKR</td>
         ...
         <table class="table-sm">
            ...
            <tr>
                ...
                <td>:</td>
                <td>{{$mInvoice->assessedPrice}} LKR</td>
             </tr>
             ...
             <tr>
                ...
                <td>:</td>
                <td>{{$mInvoice->monthInterest}} LKR</td>
...
<hr>
   ...
   <div class="row">
    ...
    <a href="/home" class="btn btn-primary" id="">OK</a>
   </div>
</div>
