...
<form id="email" action="/Admin-sendEmail1" method="post">
    {{csrf_field()}}
        ...
        <div class="card-body">
           <table class="table-sm">
               ...
               <tr>
                    <td>Subject</td>
                    <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
                    <td><input type="text" class="form-control" readonly  name="subject" style="width: 300px;" value="1st Warning Email"></td>
              </tr>
