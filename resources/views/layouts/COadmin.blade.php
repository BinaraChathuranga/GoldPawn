...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/co-home" class="nav-link" style="margin-left: 900px;">Home</a>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/co-home" class="brand-link">
          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('co-home.co-completedTransactions.index')}}" class="nav-link">
                      <i class="far fa-circle nav-icon text-success"></i>
                      <p>Completed Transactions</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{route('co-home.co-renewTransactions.index')}}" class="nav-link">
                      <i class="far fa-circle nav-icon text-warning"></i>
                      <p>Renewed Transactions</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="/co-warning1" class="nav-link">
                  ...
                  <li class="nav-item">
                    <a href="/co-warning2" class="nav-link">
                  ...
                  <li class="nav-item">
                    <a href="/co-warning3" class="nav-link">
