...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-4">
            <h1 class="m-0 text-dark">Incompleted Transactions</h1>
          </div><!-- /.col -->
          <!-- /.col -->
          <div class="col-8">
  ...
  <body>
   ...
   <div class="panel panel-default">
    <div class="panel-body">
     ...
     <h5 class="offset-4">Incompleted Transactions Details Report</h5>
