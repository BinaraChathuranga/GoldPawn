    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <!-- --------------------------------------- -->
                ...
                <form method="post" action="/renewTransaction">
        ...
        <table class="table">
            ...
            <tr>
              ...
              <td><div class="input-group-sm">
                <select name="articleName" id="articleName" class="form-control" style="width: 100px;" readonly > 
            ...
            <tr>
              <td colspan="2"><div class="input-group-sm">
                <input type="text" name="ReNIC" pattern="([0-9]{9}[V]|[0-9]{12})" oninvalid="alert('Please enter valid old or new NIC No.')" title="Please enter valid old or new NIC No." class="form-control" value="{{$RenewTrans->nicNo}}" style="width: 400px;" placeholder="NIC No." required>
              </div>
              </td>
            ...
            <tr>
              <td colspan="2"><div class="input-group-sm">
                <input type="text" name="ReAddress" class="form-control" value="{{$RenewTrans->address}}" style="width: 400px;" placeholder="Address">
              </div>
             </td>
             <td style="text-align: right;">Gold Weight</td>
             <td><div class="input-group-sm">
              <input type="text" pattern="([0-9]+|[0-9]+[\.]?[0-9]{1,2})$" oninvalid="alert('You cannot enter letters in here')" title="You cannot enter letters in here" id="goldWeight" name="Regw" class="input form-control" value="{{$RenewTrans->goldWeight}}" style="width: 100px;" required>  
                </div>
             </td>
            </tr>
            ...
            <tr>
              <td colspan="2"><div class="input-group-sm">
                <input type="text" name="Reemail" class="form-control" style="width: 400px;" value="{{$RenewTrans->email}}" placeholder="Email Address" required>
              </div>
              </td>
