...
<form id="email" action="/Admin-sendEmail3" method="post">
    {{csrf_field()}}
        ...
        <div class="card-body">
           <table class="table-sm">
               ...
               <tr>
                    <td>Subject</td>
                    <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
                    <td><input type="text" class="form-control"  name="subject" style="width: 300px;" value="3rd Warning Email" readonly></td>
              </tr>
                 @foreach($warning as $w)
              <tr>
                    <td>Messege</td>
                    <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
                    <td> <textarea type="text" class="form-control"  name="messege" style="width: 700px; height:300px;" readonly>
