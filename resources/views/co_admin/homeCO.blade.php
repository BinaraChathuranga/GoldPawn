...
<div class="content-header">
 ...
 <a href="{{route('co-home.co-transactions.create')}}" class="btn btn-primary">
  
  New Transaction</a>
      </div>

      <div class="col-3" style="margin-left:820px;" >
        <form action="/co-warning1" method="post">
          <table class="sm">
    ...
    <div class="panel-body">
      ...
      <table id="myTable" class="table table-striped table-bordered" >
        ...
        <tr id="row">
          ...
          <?php if($days>$warn1 && $days < $warn2):?> style="background-color:gray; text-align:center" <?php elseif($days>$warn2 && $days<$warn3):?>  style="background-color:#00FFFF;  text-align:center" <?php elseif($days>$warn3):?>  style="background-color:#f08080;  text-align:center" <?php endif; ?>>
               <?php echo $days;?> Days
          ...
          <td style="text-align: left;">
            <div class="btn-group">
              <a href="/co-transView/{{$t->id}}" class="btn btn-success" >View</a>
              <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="sr-only">Toggle Dropdown</span>
              </button>
              <div class="dropdown-menu">
                
                <a class="dropdown-item" href="{{route('co-home.co-transactions.edit',$t->id)}}">Edit</a>
                <a class="dropdown-item " href="/co-deleteTransaction/{{$t->id}}" onclick="return confirm('Are you sure you want to delete this Transaction?')">Delete</a>
