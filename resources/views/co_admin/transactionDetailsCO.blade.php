    ...
    <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-6 offset-6">
              ...
              <form action="{{route('co-home.co-completedTransactions.store')}}" method="post" id="completeTrans">
                {{csrf_field()}}
         ...
         <!--Renew Transaction Form -->
                  ...
                  <form action="{{route('co-home.co-renewTransactions.store')}}" method="post" id="renewTrans">
                    {{csrf_field()}}
