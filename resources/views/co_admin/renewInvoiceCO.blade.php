   ...
   <hr>
    ...
    <div class="row">
        <div class="col-12 ">
           ...
           <tr>
               <td style="text-align: left;"> <b>Transaction : <input type="text" name="transId" value="{{$RenewTrans->transId}}" readonly style="border:none;"></b> </td>
        ...
        <div class="col-4">
           ...
           <table class="table-sm ml-1">
               <tr>
                 ...
                 <td>:</td>
                   <td > <input type="text" name="Name" value="{{$RenewTrans->fullName}}" readonly style="border:none; width:150px;"> </td>
                   <input type="text" name="createdat" value="{{$RenewTrans->created_at}}" hidden readonly style="border:none; width:150px;">
               </tr>
               ...
               <tr>
                   ...
                   <td>:</td>
                   <td><input type="text" name="NIC" value="{{$RenewTrans->nicNo}}" readonly style="border:none; width:150px;"></td>
               </tr>
               ...
               <tr hidden>
                   ...
                   <td>:</td>
                   <td><input type="text" hidden name="Address" value="{{$RenewTrans->address}}" readonly style="border:none; width:150px;"></td>
                </tr>
                ...
                <tr>
                   ...
                   <td>:</td>
                   <td><input type="text" name="contact" value="{{$RenewTrans->contactNo}}" readonly style="border:none; width:150px;"></td>
                </tr>
                ...
                <tr>
                   ...
                   <td>:</td>
                   <td><input type="text" name="email" value="{{$RenewTrans->email}}" readonly style="border:none; width:150px;"></td>
                </tr>
       ...
       <div class="col-3 offset-1">
           <div class="card shadow-none border-bottom-0 border-top-0" style="width: 22rem; height:21rem; margin-left: -85px;" > 
            ...
            <table class="table-sm">
               ...
               <tr>
                  ...
                  <td>:</td>
                   <td style="text-align:right;"><input type="text" name="articleName" value="{{$RenewTrans->article}}" readonly style="border:none; width:50px;"></td>                        
                </tr>
                ...
                <tr>
                   ...
                   <td>:</td>
                   <td style="text-align:right;"><input type="text" name="karrotId" value="{{$RenewTrans->kValue}}" readonly style="border:none; width:50px;"></td>
               ...
               <tr>
                   ...
                   <td>:</td>
                   <td><input type="text" dir="rtl" name="gw" value="{{$RenewTrans->goldWeight}}" readonly style="border:none; width:50px;">g</td>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" dir="rtl" name="tMPrice" value="{{$RenewTrans->marketPrice}}" readonly style="border:none; width:50px;"> LKR</td>
         ...
         <table class="table-sm">
            ...
            <tr>
                ...
                <td>:</td>
                <td style="text-align:right;"><input type="text" dir="rtl" name="faPrice" value="{{$RenewTrans->assessedPrice}}" readonly style="border:none; width:50px;"> LKR</td>
             </tr>
             ...
             <tr>
                ...
                <td>:</td>
                <td style="text-align:right;"><input type="text" dir="rtl" name="intrestRate" value="{{$RenewTrans->intrestRate}}" readonly style="border:none; width:50px;">%  </td>
             </tr>
             ...
             <tr>
                ...
                <td>:</td>
                <td style="text-align:right;" ><input type="text" dir="rtl" name="advance" value="{{$RenewTrans->advance}}" readonly style="border:none; width:50px;"> LKR</td>
             ...
             <tr>
                ...
                <td style="text-align:right;">
                           <input type="text" name="interest" dir="rtl" value="{{$RenewTrans->interestPay}}" readonly style="border:none; width:60px;"> LKR
    ...
    <div class="card shadow-none" style="width: 25rem; margin-left: 40px;"> 
        <div class="card-body">
            <table class="table sm table-striped">
                <tr>
                    <td style="text-align: right;">Total Interest <br>
                     (ගෙවිය යුතු පොලී මුදල)</td> 
                    <td>:</td>
                    <td style="text-align: left;" >
                       <input type="text" dir="rtl" name="totalpaid" value="{{$RenewTrans->interestPay}}" readonly style="border:none; width:80px;">
                      <b> LKR</b> 
                    </td>
                </tr>
          </table>
   ...
   <div class="row">
    <div class="col-4 offset-8">
         ...
         <table class="table" id="comDeleteTrans" style=" border-bottom: none;" >
           ...
           <tbody>
            <tr>
                <td hidden>{{$RenewTrans->transId}}</td>
                <td><a href="#" class="btn btn-secondary" id="print">Print</a>
                <a href="/co-renewInvoice/{{$RenewTrans->transId}}" class="btn btn-secondary">Ok</a> 
