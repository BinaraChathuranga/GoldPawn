    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <!-- --------------------------------------- -->
                ...
                <form method="post" action="{{route('co-home.co-transactions.update',$eTrans->id)}}">
        ...
        <table class="table">
            ...
            <tr>
              ...
              <td><div class="input-group-sm">
                <select name="articleName" readonly id="articleName" class="form-control" style="width: 100px;" > 
            ...
            <tr>
              ...
              <td><div class="input-group-sm">
                <select id="karrotId" readonly name="karrotId" class="form-control" style="width: 100px;">  
            ...
            <tr>
              <td colspan="2"><div class="input-group-sm">
              <textarea cols="30" rows="3" type="text" name="eAddress" class="form-control" value="" style="width: 400px;" placeholder="Address" required>{{$eTrans->address}}</textarea>
              </div>
             </td>
             <td style="text-align: right;">Gold Weight</td>
             <td><div class="input-group-sm">
              <input type="text" pattern="([0-9]+|[0-9]+[\.]?[0-9]{1,2})$" oninvalid="alert('You cannot enter letters in here')" title="You cannot enter letters in here" readonly id="goldWeight" name="egw" class="input form-control" value="{{$eTrans->goldWeight}}" style="width: 100px;">  
                </div>
             </td>
            </tr>
            ...
            <tr>
              <td colspan="2"> <div class="input-group-sm">
                <input type="text" pattern="[0-9]{9}" oninvalid="alert('Please Contact number with 10 digits')" title="Please enter Contact number with 10 digits" name="econtact" class="form-control" style="width: 400px;" value="{{$eTrans->contactNo}}" placeholder="Contact No:" required>
              </div>
              </td>
              <td style="text-align: right;">Market Price</td>
              <td><div class="input-group-sm">
                <input type="text" readonly id="tmPrice" name="etMPrice" readonly class="input form-control" value="{{$eTrans->marketPrice}}"  style="width: 100px;" > 
              </div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td><div class="input-group-sm">
                <input type="text" readonly name="efaPrice" id="faPrice" readonly class="form-control" value="{{$eTrans->assessedPrice}}" style="width: 100px;">
              </div>
            </td>
            </tr>
            ...
            <tr>
              ...
              <td><div class="input-group-sm">
                <input type="text" readonly name="eadvance" id="advance" value="{{$eTrans->advance}}" class="input form-control" style="width: 100px;" >
                </div>
              </td>
            </tr>
