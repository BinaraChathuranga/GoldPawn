...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-4">
            <h1 class="m-0 text-dark">2nd warning Transactions</h1>
          </div><!-- /.col -->
          <!-- /.col -->
          <div class="col-8">
          <img style="height: 50px; margin-left: -70px; width:790px;" src="{{asset('img/gp.png')}}" alt="">
          </div>
      ...
      <table id="myTable" class="table table-striped table-bordered" >
        ...
        <tr id="row">
          ...
          <td style="text-align: left;">
            <div class="btn-group">
              <a href="/co-warning2-view/{{$d->id}}" class="btn btn-success" >Email</a>
              <a href="/co-warning2letter-view/{{$d->id}}" class="btn btn-success" >Letter</a>
            </div>
          </td>
        </tr>
        @endforeach
