    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <!-- --------------------------------------- -->
              ...
              <form method="post" action="{{route('co-home.co-transactions.store')}}"> 
        ...
        <table class="table">
            ...
            <td>NIC No</td>
              ...
              <td><div class="input-group-sm">
                ...
                <select id="karrotId" name="karrotId" class="form-control" style="width: 100px;" required> 
                <option value="" hidden selected >-select-</option> 
            ...
            <td>Address</td>
             ...
             <td><div class="input-group-sm">
              <input type="text" pattern="([0-9]+|[0-9]+[\.]?[0-9]{1,2})$" oninvalid="alert('You cannot enter letters in here')" title="You cannot enter letters in here" id="goldWeight" name="gw" class="input form-control" placeholder="eg: 1 or 1.50" style="width: 100px;" required>  
                </div>
             </td>
            </tr>
            ...
            <tr>
              <td>Tel No.</td>
              <td> <div class="input-group-sm">
                <input type="text" pattern="[0-9]{10}" oninvalid="alert('Please enter Contact number with 10 digits')" title="Please Contact number with 10 digits" name="contact" class="form-control" style="width: 300px;" placeholder="eg: 0123456789" required>
              </div>
              </td>
              <td style="text-align: right;">Market Price</td>
              <td><div class="input-group-sm">
                <input type="text" id="tmPrice" name="tMPrice" readonly class="input form-control"  style="width: 100px;" > 
              </div>
              </td>
            </tr>
            ...
            <td>Email</td>
              ...
              <td><div class="input-group-sm">
                <input type="text" name="faPrice" id="faPrice" readonly class="form-control" style="width: 100px;">
              </div>
            </td>
            </tr>
            ...
            <tr>
              ...
              <td><div class="input-group-sm">
                <input type="text" name="advance" pattern="[0-9]+" oninvalid="alert('You cannot enter letters in here')" title="You cannot enter letters in here" id="advance" class="input form-control" style="width: 100px;" required >
                </div>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td><div class="input-group-sm">
                <input type="text" name="interest" id="interest" readonly class="form-control" style="width: 100px;">
                 </div>
              </td>
            </tr>
             <tr>
                 ...
                 <td colspan="3" style="text-align: right;" ><button type="submit" class="btn btn-primary" id="subTrans">Submit</button></td>
          ...
          <div class="card" style="width: 320px; margin-left:30px;"> 
            <div class="card-body">
                <table>
                    ...
                    <tr>
                       ...
                       <select name="interestRate" dir="rtl" id="interestRate" readonly class="form-control"  style="width: 100px;" required> 
                        ...
                        <td>%</td>
                          ...
                          <input hidden dir="rtl" type="text" name="mainBalance"  class="form-control" id="mainBalance" value="{{$ledger->avaBal}}" style="width:100px;" readonly>
                          </td>
                    ...
                    <tr hidden>
                    <input hidden dir="rtl" type="text" name="mainBalance"  class="form-control" id="mainBalance" value="" style="width:100px;" readonly>
                          </td>
                          <td >LKR</td>
                    </tr>
                  ...
                  <tr>
                      <td style="text-align: right;">Total Balance :</td>
                          ...
                          <input dir="rtl" type="text" name="totalBal"  class="form-control" id="totalBal" value="{{$total}}" style="width:100px;" readonly>
                          </td>
                          <td>LKR</td>
                      </tr> 
              ...
              <div class="alert alert-danger collapse" id="alert"  style="width: 320px; margin-left:30px;">
                ...
                Please Renew Balance and Try Again, <br> <br>
                 <a href="/co-home" style="color: black;">click here </a> to Return Home 
                </div>
